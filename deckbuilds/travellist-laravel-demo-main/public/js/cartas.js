...
//             },
//             type: "post",
//             url: "http://153.92.211.87:8000/crearPost",// ó {{url(/admin/empresa)}} depende a tu peticion se dirigira a el index(get) o tu store(post) de tu controlador 
//             data: {
//                 "cartas" : cartas,
//                 "cantidad" : cantidad,
//                 "portadaB" : portadaB,
...
function generarCartas(cartas) {
    ...
    cartas.forEach(element => {
        ...
        if ($('#'+element["id"]).length==0) {
            ...
            let nombreReplace=element["nombre"];
            nombreCarta.innerText = nombreReplace.replace("A-","");
    ...
    div.addEventListener("click", function () {
        if (formato.selectedIndex != 0) {
            ...
            sumar.addEventListener("click", function () {
                ...
                if (((hermano.innerText < 4 && formato.value == "Modern") || tipo.indexOf("Basic Land") != -1) || (formato.value == "Commander" && tipo.indexOf("Basic Land") != -1)) {
                    hermano.innerText++;
                    total.innerText++;
            ...
            alert("Selecciona formato para añadir cartas");
        }
    });
};
